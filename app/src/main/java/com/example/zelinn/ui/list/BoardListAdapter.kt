...
class BoardListAdapter() : AndroidListAdapter<ListModel, ListItemViewHolder>(ListItemCallback()) {
    ...
    lateinit var editListCallback: (ListModel) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListItemViewHolder {
        ...
        return ListItemViewHolder(root, addCardCallback, addListCallback, editListCallback)
    }
    ...
    fun submitLists(list: List<ListModel>, commitCallback: Runnable?) {
        ...
        val addList = ListModel("ADDING", "", null, listOf())
