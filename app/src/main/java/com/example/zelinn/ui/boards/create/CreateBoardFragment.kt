package com.example.zelinn.ui.boards.create
...
import com.example.zelinn.ui.board.BoardPermissionFragment
...
class CreateBoardFragment : Fragment() {
    ...
    private val backPressedCallback = object: OnBackPressedCallback(true) {
        override fun handleOnBackPressed() {
            this.remove()
            requireActivity().supportFragmentManager.popBackStack(BoardPermissionFragment.TAG, FragmentManager.POP_BACK_STACK_INCLUSIVE)
        }
    }

    companion object {
        const val TAG = "CREATE_BOARD"
    }
    ...
    override fun onCreateView(
        ...
        permissionBtn.setOnClickListener {
            val permissionFragment = BoardPermissionFragment()
            ...
            activity.supportFragmentManager.beginTransaction()
                ...
                .replace(R.id.boards_fragment_container, permissionFragment, BoardPermissionFragment.TAG)
                .addToBackStack(BoardPermissionFragment.TAG)
                .commit()
        }
    ...
    private fun checkValid() {
        ...
        val permission = model.boardPermission.value

        createBtn.isEnabled = !boardName.isNullOrEmpty() && boardThumbnail != null && permission != null
    }
    ...
    private fun postBoard(thumbnail: String) {
        val name = model.boardName.value ?: return
        val permission = model.boardPermission.value ?: return

        val body = PostBoardBody(name, thumbnail, permission)
