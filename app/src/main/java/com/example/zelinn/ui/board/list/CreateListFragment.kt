...
class CreateListFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        positionInput.doAfterTextChanged {
            updateValidState()
        }
    ...
    private fun findViews() {
        ...
        positionInput = binding.root.findViewById(R.id.create_list_position_input)
        progressView = binding.root.findViewById(R.id.create_list_progress)
    }

    private fun updateValidState() {
        valid = nameInput.text.toString().isNotEmpty() && positionInput.text.toString().isNotEmpty() && positionInput.text.toString().toInt() > 0
    ...
    private fun toggleLoadingState() {
        ...
        positionInput.isEnabled = !isLoading
    }
    ...
    private fun createList() {
        ...
        val position = positionInput.text.toString().toInt()
        val body = CreateListBody(board.id, name, position)
